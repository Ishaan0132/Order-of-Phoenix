...
exports.commands = {
	customavatar: {
		set: function (target, room, user) {
			...
			this.checkCan('avatar', null, room);
			...
			if (Users.get(name)) Users.get(name).popup("|html|" + Server.nameColor(user.name, true) + " set your custom avatar.<br /><center><img src='" + avatarUrl + "' width='80' height='80'></center><br /> Refresh your page if you don't see it.");
		},
